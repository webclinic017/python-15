...
#    frame['SMA100']=indicators.talib.SMA(frame.Close, timeperiod=100) #make this variable
    frame['SMA50']=indicators.talib.SMA(frame.Close, timeperiod=150) #make this variable
    frame['SMA21']=indicators.talib.SMA(frame.Close, timeperiod=21) #make this variable
...
#            if frame.iloc[i].approach_high: #if high approach signal is 1 or true (signal is near the upper band)
    ...
    f = open("hours_held.csv", "a", newline="")
